...
export default {
  ...
  validations: {
    customers: {
      supplier: {
        required: helpers.withMessage("請填寫供應商名稱", required),
      },
      supplierall: {
        required: helpers.withMessage("請填寫供應商全名", required),
      },
  ...
  methods: {
    ...
    EditOne(RowItem) {
      ...
      if (RowItem.id == null || RowItem.id == 0) {
        ...
        this.customers.rent = RowItem.rent;
    ...
    GetData() {
      ...
      //let APIParameter = encodeURIComponent(`search={"supplier":"","type":"供應商","telephone":"","phonenum":""}&column=createTime&order=desc&field=id,,,action,supplier,supplierall,taxid,contacts,telephone,phoneNum,email,sort,enabled&currentPage=1&pageSize=10`);
              ...
              <div class="col-sm-8">
                <div class="search-box me-2 mb-2 d-inline-block">
                  <div class="position-relative">
                    <input type="text" class="form-control" placeholder="供應商名稱" v-model="supplier"
                      @keyup.enter="GetData()" />
                  </div>
                </div>
                <div class="search-box me-2 mb-2 d-inline-block">
              ...
              <div class="col-sm-4">
                <div class="text-sm-end">
                  <button type="button" class="btn btn-success btn-rounded mb-2 me-2" @click="EditOne({ id: 0 })">
                    <i class="mdi mdi-plus me-1"></i> 新增供應商
                  </button>
                  <b-modal size="xl" v-model="showModal" :title="customers.id == 0 ? '新增供應商' : '修改供應商'"
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-3">
                          <div class="mb-3">
                            ...
                            <input id="name" v-model="customers.taxid" type="text" class="form-control" />
                          </div>
                        </div>
                        <div class="col-sm-12 col-md-4 col-lg-3">
                          <div class="mb-3">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-3">
                          <div class="mb-3">
                            <label for="name">租金</label>
                            <input id="name" v-model="customers.rent" type="text" class="form-control" />
                          </div>
                        </div>
                        <div class="col-12">
                          <div class="mb-3">
