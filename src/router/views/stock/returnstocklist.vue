            ...
            server.get(APIUrl, { responseType: 'blob' })
                .then((res) => {
                    ...
                    if (res != null && res.data != null) {
                        ...
                        fileLink.setAttribute('download', `批次匯出退貨單_${dayjs().format("YYYYMMDD_HHmmss")}.zip`);
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="search-box me-2 mb-2 d-inline-block">
                                    <div class="position-relative">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" placeholder="退貨單號"
                                            ...
                                            <tbody>
                                                <tr v-for="(SubItem, cidx) in customersItem" :key="SubItem.id">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input autocomplete="off" type="text" class="form-control"
                                                            v-if="IsPickup1" v-model="SubItem.counterName">
                                                    </td>
