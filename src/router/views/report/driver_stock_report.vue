...
export default {
  ...
  methods: {
    ...
    GetSubData(SubItem, dStatus) {
      ...
      if (SubItem == null) return;
      if (
        SubItem[`status${dStatus}Count`] == null ||
        String(SubItem[`status${dStatus}Count`]) == "0"
      )
        return;
      this.SubView = 1;
        ...
        <div class="col-sm-12">
          ...
          <div class="search-box me-2 mb-2 d-inline-block">
            ...
            >
              <option
                v-for="(lp1, lpidx) in [
                  { licensePlateNumber: '', driverName: '全部車牌' },
                  ...VehicleList,
                ]"
            ...
            <div class="table-responsive">
              <div class="table-responsive">
                <table class="table table-centered table-nowrap align-middle">
                  ...
                  <tbody>
                    <tr
                      v-for="(SubItem, cidx) in customersSubData"
